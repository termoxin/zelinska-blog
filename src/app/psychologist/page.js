  ...
  return (
    <div className="container">
      <header>
        ...
        <p>
          Ты часто тревожишься? Переживаешь обо всём, начиная с утра?
        </p>
        <p>
          Внутри ощущение беспомощности и трудно остановить поток мыслей? <strong>Возможно, ты как раз в нужном месте.</strong>
        </p>
        <p>
