  ...
  return (
    <div className="container">
      <header>
        ...
        <p>
          <strong>Я сама знаю, каково это — жить с тревогой.</strong> Поэтому мне важно не только давать работающие инструменты, но и создавать тёплое, безопасное пространство.
        </p>
        <p>
          Здесь можно быть собой, расслабиться и почувствовать опору.
        </p>
      ...
      <section className="section" ref={addToRefs}>
        ...
        <div className="two-col">
          ...
          <div className="box">
            ...
            <p>
              Магистратура с аккредитацией <strong>BPS</strong>: учебная часть завершена. Сейчас пишу диссертацию и провожу исследование.
            </p>
          </div>
          <div className="box">
            <div className="logo-wrapper">
